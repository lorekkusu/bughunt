# python-pricing · claude/claude-opus-4-8 · effort=`low`
...
| Speed (s) | 45.9 | 40.9 | 53.9 |
| Output tokens | 3,125 | 2722 | 3874 |
| Est. cost (USD, API-equiv) | 0.2296 | 0.2040 | 0.2700 |
...
- refund divide-by-zero when days_total==0 — seen in 1/3 runs
- allocate divide-by-zero when line_count==0 — seen in 1/3 runs
- allocate ZeroDivisionError on empty line_count — seen in 1/3 runs
- refund divide-by-zero when days_total == 0 — seen in 1/3 runs
