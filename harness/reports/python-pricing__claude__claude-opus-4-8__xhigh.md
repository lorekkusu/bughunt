# python-pricing · claude/claude-opus-4-8 · effort=`xhigh`
...
| Speed (s) | 153.5 | 129.1 | 178.9 |
| Output tokens | 11,802 | 9940 | 13438 |
| Est. cost (USD, API-equiv) | 0.4811 | 0.4345 | 0.5215 |
...
| L1 | low | Loyalty threshold uses > instead of >= (spend exactly at a threshold misqualified) | ⚠️ 1/3 |
...
- allocate ZeroDivisionError on zero line_count — seen in 1/3 runs
