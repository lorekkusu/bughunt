# python-scheduling · codex/gpt-5.5 · effort=`xhigh`
...
| Bonus real bugs | 2.7 | 1 | 4 |
| Speed (s) | 467.5 | 219.4 | 944.5 |
| Output tokens | 9,330 | 6009 | 11419 |
| Est. cost (USD, API-equiv) | 0.4486 | 0.2821 | 0.5358 |
...
- free_slots ignores existing bookings — seen in 2/3 runs
- Zero/negative step causes non-terminating loop in free_slots/next_available — seen in 1/3 runs
- free_slots infinite loop when minutes<=0 — seen in 1/3 runs
- next_available infinite loop when minutes<=0 — seen in 1/3 runs
- next_available doesn't check full interval length — seen in 1/3 runs
- minutes<=0 causes infinite loop — seen in 1/3 runs
- next_available doesn't check full interval free — seen in 1/3 runs
