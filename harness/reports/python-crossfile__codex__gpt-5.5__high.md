# python-crossfile · codex/gpt-5.5 · effort=`high`
...
| Speed (s) | 176.7 | 166.4 | 187.4 |
| Output tokens | 7,549 | 6995 | 8080 |
| Est. cost (USD, API-equiv) | 0.7191 | 0.6030 | 0.8068 |
...
| L1 | low | D0 | parse_duration minutes branch multiplies by 6000 instead of 60000 | ⚠️ 2/3 |
...
- retention cutoffs still in seconds vs millis event ts — seen in 1/3 runs
