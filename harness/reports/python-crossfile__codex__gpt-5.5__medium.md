# python-crossfile · codex/gpt-5.5 · effort=`medium`
...
| Speed (s) | 146.0 | 137.2 | 156.5 |
| Output tokens | 6,193 | 5652 | 6746 |
| Est. cost (USD, API-equiv) | 0.6595 | 0.5176 | 0.7692 |
...
| L1 | low | D0 | parse_duration minutes branch multiplies by 6000 instead of 60000 | ⚠️ 1/3 |
...
- retention.py compares millis event ts to seconds cutoff — seen in 1/3 runs
