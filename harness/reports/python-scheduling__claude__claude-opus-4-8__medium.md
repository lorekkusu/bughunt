# python-scheduling · claude/claude-opus-4-8 · effort=`medium`
...
| Speed (s) | 55.6 | 52.1 | 57.6 |
| Output tokens | 4,136 | 3812 | 4359 |
| Est. cost (USD, API-equiv) | 0.2460 | 0.2403 | 0.2493 |
...
| C2 | critical | has_conflict skips bookings on a different calendar date → misses midnight-spanning conflicts | ⚠️ 2/3 |
