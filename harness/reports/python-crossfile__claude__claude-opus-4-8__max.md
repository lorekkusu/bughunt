# python-crossfile · claude/claude-opus-4-8 · effort=`max`
...
| Speed (s) | 483.2 | 454.0 | 515.1 |
| Output tokens | 32,781 | 30872 | 34706 |
| Est. cost (USD, API-equiv) | 1.9141 | 1.8083 | 2.0190 |
...
- Event-log ms migration breaks retention pruning — seen in 1/3 runs
