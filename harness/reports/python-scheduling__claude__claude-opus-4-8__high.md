# python-scheduling · claude/claude-opus-4-8 · effort=`high`
...
| Speed (s) | 58.8 | 52.9 | 66.7 |
| Output tokens | 4,268 | 4056 | 4556 |
| Est. cost (USD, API-equiv) | 0.2569 | 0.2459 | 0.2755 |
...
- free_slots never consults existing bookings — seen in 1/3 runs
