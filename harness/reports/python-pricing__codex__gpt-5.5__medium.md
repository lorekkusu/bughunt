# python-pricing · codex/gpt-5.5 · effort=`medium`
...
| Speed (s) | 117.9 | 106.3 | 123.7 |
| Output tokens | 4,583 | 4274 | 4789 |
| Est. cost (USD, API-equiv) | 0.2735 | 0.2384 | 0.3224 |
...
- allocate() ZeroDivisionError on line_count=0 — seen in 1/3 runs
- refund_amount() unvalidated days_total (crash / negative refund) — seen in 1/3 runs
