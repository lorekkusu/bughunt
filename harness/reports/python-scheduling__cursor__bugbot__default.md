# python-scheduling · cursor/bugbot · effort=`default`
...
| H3 | high | free_slots uses `t <= day_end`, emitting a slot starting at/after the day end (off-by-one) | ⚠️ 1/3 |
...
- first_booking IndexError on empty schedule — seen in 2/3 runs
- first_booking raises IndexError on empty schedule — seen in 1/3 runs
- free_slots does not exclude occupied times — seen in 1/3 runs
- free_slots never excludes booked times — seen in 1/3 runs
